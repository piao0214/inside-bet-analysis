  ...
  shiny::fluidPage(
    ...
    shiny::sidebarLayout(
      shiny::sidebarPanel(
        ...
        shiny::hr(),
        shiny::textInput("ollama_url", "Ollama URL", "http://localhost:11434"),
        shiny::actionButton("refresh_models", "刷新模型"),
        shiny::verbatimTextOutput("ollama_status"),
        shiny::selectInput("ollama_model", "Ollama 模型", choices = NULL),
