      ...
      shiny::mainPanel(
        shiny::tabsetPanel(
          ...
          shiny::tabPanel(
            ...
            shiny::tags$br(),
            shiny::helpText(
              "判定規則：85% CI 完全高於 0 = 上漲；包含 0 = 正常；完全低於 0 = 下跌。"
            ),
            shiny::tags$h3("遊戲預測分類"),
            shiny::tableOutput("game_direction_table"),
            shiny::uiOutput("game_direction_note"),
            shiny::tags$hr(),
            shiny::tags$h3("店家預測分類"),
            shiny::tableOutput("store_direction_table"),
            shiny::uiOutput("store_direction_note")
          ),
